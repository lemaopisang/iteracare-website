...
@section('description', 'Baca testimoni dari pelanggan kami yang telah merasakan manfaat teknologi Terahertz Prife
Indonesia.')
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        ...
                        <a href="https://wa.me/{{ preg_replace('/[^0-9]/', '', $testimonial->user->whatsapp) }}"
                            target="_blank"
