...
<div class="min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-blue-50 to-purple-50 py-12">
    <div class="bg-white rounded-xl shadow-lg p-8 w-full max-w-2xl text-left">
        ...
        <p class="mb-4">Situs ini menggunakan cookie untuk meningkatkan pengalaman pengguna dan menganalisis penggunaan
            situs.</p>
        <h2 class="text-xl font-semibold mt-6 mb-2">1. Apa itu Cookie?</h2>
        <p class="mb-4">Cookie adalah file kecil yang disimpan di perangkat Anda saat mengunjungi situs web. Cookie
            membantu kami mengenali Anda dan menyesuaikan layanan kami.</p>
        ...
        <p class="mb-4">Anda dapat mengatur browser Anda untuk menolak atau menghapus cookie. Namun, beberapa fitur
            situs mungkin tidak berfungsi dengan baik tanpa cookie.</p>
        <h2 class="text-xl font-semibold mt-6 mb-2">4. Perubahan Kebijakan</h2>
        <p class="mb-4">Kami dapat memperbarui kebijakan cookie ini dari waktu ke waktu. Perubahan akan diumumkan di
            halaman ini.</p>
