<div class="bg-gradient-to-r from-gray-900 via-blue-900 to-purple-900 text-white">
    ...
    @if(request()->route() && request()->route()->getName() !== 'penjelasan')
        @livewire('referral-search', ['referralCode' => session('referral_name')])
    @endif
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li><a href="{{ route('testimonials') }}" class="text-gray-300 hover:text-white transition-colors duration-200">Testimonials</a></li>
                        <li><a href="{{ route('contact') }}" class="text-gray-300 hover:text-white transition-colors duration-200">Contact</a></li>
                        <li><a href="{{ route('penjelasan') }}" class="text-gray-300 hover:text-white transition-colors duration-200">Penjelasan</a></li>
                    </ul>
                </div>
