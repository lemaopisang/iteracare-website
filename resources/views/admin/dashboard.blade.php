                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">{{ $stats['sales_users'] }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-5 w-0 flex-1">
                                    <dl>
                                        ...
                                        <dd class="text-lg font-medium text-gray-900">{{ $stats['total_testimonials'] }}</dd>
                                    </dl>
                                </div>
                            </div>
                        </div>
                ...
                <div class="grid grid-cols-1 gap-6 lg:grid-cols-2 mt-6">
                    ...
                    <div class="bg-white shadow rounded-lg">
                        <div class="px-4 py-5 sm:p-6">
                            ...
                            <div class="flow-root">
                                <ul class="-my-5 divide-y divide-gray-200">
                                    @forelse($recent_testimonials as $testimonial)
                                        <li class="py-4">
                                            <div class="flex items-center space-x-4">
                                                <div class="flex-shrink-0">
                                                    <div class="h-8 w-8 rounded-full bg-yellow-200 flex items-center justify-center">
                                                        <span class="text-sm font-medium text-yellow-800">{{ substr($testimonial->customer_name, 0, 1) }}</span>
                                                    </div>
                                                </div>
                                                <div class="flex-1 min-w-0">
                                                    <p class="text-sm font-medium text-gray-900 truncate">{{ $testimonial->customer_name }}</p>
                                                    <p class="text-sm text-gray-500 truncate">{{ $testimonial->customer_location }}</p>
                                                </div>
                                                <div class="flex-shrink-0">
                                                    <div class="flex items-center">
                                                        @for($i = 1; $i <= 5; $i++)
