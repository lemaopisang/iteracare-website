...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
            ...
            <form method="POST" action="{{ route('sales.testimonials.store') }}" class="space-y-6"
                        ...
                        <div class="flex-1">
                            <div class="flex items-center mb-2">
                                ...
                                <div class="ml-4 flex items-center">
                                    @for($i = 1; $i <= 5; $i++) <i class="fas fa-star {{ $i <= $testimonial->rating ? "
                                        text-yellow-400" : "text-gray-300" }} text-sm"></i>
                                        @endfor
                            ...
                            <div class="mb-3">
                                <video controls preload="metadata" class="w-full max-w-4xl rounded shadow aspect-video"
                            ...
                            $videoId = '';
                            $embedUrl = '';
                            if (strpos($testimonial->video_url, 'youtube.com') !== false ||
                            strpos($testimonial->video_url, 'youtu.be') !== false) {
