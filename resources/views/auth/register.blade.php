    ...
    <form method="POST" action="#" class="space-y-4">
        ...
        <div>
            ...
            <select id="requested_role" name="requested_role" required
                ...
                <option value="sales" {{ old('requested_role') == 'sales' ? 'selected' : '' }}>Sales Representative</option>
        ...
        <div class="grid grid-cols-2 gap-4">
            <div>
                ...
                <x-text-input id="instagram" class="block mt-1 w-full" type="text" name="instagram" :value="old('instagram')" placeholder="@username" />
            </div>
            <div>
                <x-input-label for="facebook" :value="__('Facebook (Optional)')" />
                <x-text-input id="facebook" class="block mt-1 w-full" type="text" name="facebook" :value="old('facebook')" placeholder="Profile URL" />
            </div>
        </div>
        ...
        <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
            <div class="flex items-start">
                ...
                <div class="text-sm text-blue-800">
                    ...
                    <p>Your registration request will be reviewed by our admin team. You will receive an email notification once your account has been approved and activated.</p>
                </div>
            </div>
        </div>
