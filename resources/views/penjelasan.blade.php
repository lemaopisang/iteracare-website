    ...
    <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div class="flex flex-col items-center">
                <a href="#terahertz"><img src="{{ asset('prifeindonesia_images/Terahertz.jpg') }}" alt="Terahertz" class="mb-6 rounded-xl shadow-lg w-48 h-48 object-cover"></a>
            ...
            <div class="flex flex-col items-center">
                <a href="#limfatik"><img src="{{ asset('prifeindonesia_images/Lymphatic.jpg') }}" alt="Sistem Limfatik" class="mb-6 rounded-xl shadow-lg w-48 h-48 object-cover"></a>
            ...
            <div class="flex flex-col items-center">
                <a href="#pemf"><img src="{{ asset('prifeindonesia_images/PEMF.jpg') }}" alt="PEMF" class="mb-6 rounded-xl shadow-lg w-48 h-48 object-cover"></a>
            ...
            <div class="flex flex-col items-center">
                <a href="#ion"><img src="{{ asset('prifeindonesia_images/Ion.jpg') }}" alt="Ion" class="mb-6 rounded-xl shadow-lg w-48 h-48 object-cover"></a>
