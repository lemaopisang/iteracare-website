...
<?php $__env->startSection('description', 'Baca testimoni dari pelanggan kami yang telah merasakan manfaat teknologi Terahertz Prife
Indonesia.'); ?>
...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-purple-50 py-12">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-12">
            ...
            <p class="text-xl text-gray-600">Dengarkan dari pelanggan kami yang telah merasakan kekuatan transformatif
                teknologi Terahertz</p>
        </div>
            ...
            <div class="bg-white rounded-2xl shadow-lg p-8 hover:shadow-xl transition-shadow duration-300">
                ...
                <div class="flex items-center mb-4">
                    ...
                    <div class="ml-4">
                        ...
                        <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $testimonial->user->whatsapp)); ?>"
                            target="_blank"
                            class="inline-flex items-center mt-1 px-3 py-1 bg-green-500 text-white text-xs rounded hover:bg-green-600">
                ...
                <div class="flex mb-4">
                    <?php for($i = 1; $i <= 5; $i++): ?> <i
                        class="fas fa-star <?php echo e($i <= $testimonial->rating ? 'text-yellow-400' : 'text-gray-300'); ?>"></i>
                        <?php endfor; ?>
        ...
        <div class="mt-16 text-center">
            <div class="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl p-8 text-white">
                ...
                <p class="text-xl mb-8">Bergabunglah dengan ribuan pelanggan yang telah mengubah kesehatan mereka dengan
                    teknologi Terahertz.</p>
                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="mailto:info@iteracare.com" class="inline-flex items-center px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
