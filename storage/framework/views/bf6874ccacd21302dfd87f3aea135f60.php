...
<div class="space-y-6">
    ...
    <div class="bg-white shadow sm:rounded-lg">
        <form method="POST" action="<?php echo e(route('admin.users.store')); ?>" class="space-y-6 p-6">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                    ...
                    <div>
                        ...
                        <select name="role" id="role" required
                            ...
                            <option value="sales" <?php echo e(old('role') === 'sales' ? 'selected' : ''); ?>>Sales Representative</option>
                        </select>
                    </div>
                ...
                <div class="grid grid-cols-1 gap-6">
                    <div>
                        ...
                        <textarea name="bio" id="bio" rows="3"
                                  class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm"><?php echo e(old('bio')); ?></textarea>
            ...
            <div>
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-3">
                    ...
                    <div>
                        ...
                        <input type="text" name="facebook" id="facebook" value="<?php echo e(old('facebook')); ?>"
                               class="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500 sm:text-sm">
                    </div>
                    ...
                    <div>
                        ...
                        <input type="url" name="whatsapp" id="whatsapp" value="<?php echo e(old('whatsapp')); ?>"
...
<?php echo $__env->make('admin.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\manus\v3\iteracare-website\resources\views/admin/users/create.blade.php ENDPATH**/ ?>