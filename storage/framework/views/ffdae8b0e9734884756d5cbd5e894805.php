                    ...
                    <div class="flex items-center">
                        ...
                        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                            ...
                            <a href="<?php echo e(route('testimonials')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('testimonials') ? 'active' : ''); ?>">
                            ...
                            <a href="<?php echo e(route('penjelasan')); ?>"
                                class="nav-link <?php echo e(request()->routeIs('penjelasan') ? 'active' : ''); ?>">
...
<?php endif; ?>
                        <?php else: ?>
                        <a href="<?php echo e(route('sales.area')); ?>"
            ...
            <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
                <div class="pt-2 pb-3 space-y-1">
                    <a href="<?php echo e(route('home')); ?>"
                        class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium <?php echo e(request()->routeIs('home') ? 'border-blue-400 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'); ?> transition duration-150 ease-in-out">
                        Home
                    </a>
                    <a href="<?php echo e(route('testimonials')); ?>"
                        class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium <?php echo e(request()->routeIs('testimonials') ? 'border-blue-400 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'); ?> transition duration-150 ease-in-out">
                        Testimonials
                    </a>
                    <a href="<?php echo e(route('contact')); ?>"
                        class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium <?php echo e(request()->routeIs('contact') ? 'border-blue-400 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'); ?> transition duration-150 ease-in-out">
                        Contact
                    </a>
                    <a href="<?php echo e(route('penjelasan')); ?>"
                        class="block pl-3 pr-4 py-2 border-l-4 text-base font-medium <?php echo e(request()->routeIs('penjelasan') ? 'border-blue-400 text-blue-700 bg-blue-50' : 'border-transparent text-gray-600 hover:text-gray-800 hover:bg-gray-50 hover:border-gray-300'); ?> transition duration-150 ease-in-out">
                        Penjelasan
                    </a>
                </div>
