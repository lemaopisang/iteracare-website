    ...
    <div class="bg-gradient-to-r from-blue-50 to-purple-50 py-16" id="referral-section">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-8">
                ...
                <p class="text-lg text-gray-600">Masukkan nama atau kode referral sales untuk mendapatkan kontak WhatsApp mereka</p>
            </div>
            <div class="bg-white rounded-2xl shadow-xl p-8 backdrop-blur-sm border border-blue-100">
                ...
                <div wire:loading.remove>
                    <!--[if BLOCK]><![endif]--><?php if($showResult && $foundUser): ?>
                        <div class="bg-gradient-to-r from-green-50 to-blue-50 border border-green-200 rounded-xl p-6 animate-fade-in">
                            <div class="flex items-start space-x-6">
                                <div class="flex-shrink-0">
                                    <div class="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full flex items-center justify-center text-white text-2xl font-bold">
                                        <?php echo e(substr($foundUser->name, 0, 1)); ?>

                                    </div>
                                </div>
                                <div class="flex-1">
                                    <h4 class="text-2xl font-bold text-gray-900 mb-2"><?php echo e($foundUser->name); ?></h4>
                                    <!--[if BLOCK]><![endif]--><?php if($foundUser->bio): ?>
                                        <p class="text-gray-600 mb-4"><?php echo e($foundUser->bio); ?></p>
                                    <?php endif; ?><!--[if ENDBLOCK]><![endif]-->
                                    <div class="flex flex-wrap gap-3">
                                        <!--[if BLOCK]><![endif]--><?php if($foundUser->whatsapp): ?>
                                            <a href="https://wa.me/<?php echo e(preg_replace('/[^0-9]/', '', $foundUser->whatsapp)); ?>"
                                               target="_blank"
                                        ...
                                        <span class="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-800 rounded-lg">
                                            <i class="fas fa-phone mr-2"></i><?php echo e($foundUser->phone); ?>

                                        </span>
                                        <span class="inline-flex items-center px-4 py-2 bg-gray-100 text-gray-800 rounded-lg">
                                            <i class="fas fa-envelope mr-2"></i><?php echo e($foundUser->email); ?>
                    ...
                    <?php elseif($errorMessage): ?>
                        <div class="bg-red-100 border border-red-200 text-red-700 rounded-lg p-4 mt-4 animate-fade-in">
                            <i class="fas fa-exclamation-circle mr-2"></i><?php echo e($errorMessage); ?>
...
<?php /**PATH C:\laragon\www\manus\v3\iteracare-website\resources\views/livewire/referral-search.blade.php ENDPATH**/ ?>