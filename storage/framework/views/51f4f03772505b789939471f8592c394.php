<?php $__env->startSection('title', 'Page Not Found - Prife Indonesia'); ?>
    ...
    <div class="max-w-md mx-auto text-center px-4">
        ...
        <div class="space-y-4">
            ...
            <div class="flex justify-center space-x-4 text-sm">
                <a href="<?php echo e(route('testimonials')); ?>" class="text-blue-600 hover:text-blue-700">Testimonials</a>
                <span class="text-gray-400">|</span>
                <a href="<?php echo e(route('contact')); ?>" class="text-blue-600 hover:text-blue-700">Contact</a>
            </div>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\manus\v3\iteracare-website\resources\views/errors/404.blade.php ENDPATH**/ ?>